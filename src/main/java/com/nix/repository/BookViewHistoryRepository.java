...
public interface BookViewHistoryRepository extends JpaRepository<BookViewHistory, UUID> {
    ...
    List<BookViewHistory> findViewsBetweenDates(@Param("startDate") LocalDateTime startDate, @Param("endDate") LocalDateTime endDate);
    ...
    List<Book> findTrendingBooks(@Param("since") LocalDateTime since, @Param("minViews") long minViews, Pageable pageable);
    ...
    long getViewCountForBookBetweenDates(@Param("bookId") UUID bookId, @Param("startDate") LocalDateTime startDate, @Param("endDate") LocalDateTime endDate);
}